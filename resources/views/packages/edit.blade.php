...
<head>
    <title>{{__('translations.edit_package')}}</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet"
          integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
    <link href="{{ asset('css/menu.css') }}" rel="stylesheet">
    <link href="{{ asset('css/packages/packages-edit.css') }}" rel="stylesheet">
...
<div class="container-fluid">
    <div class="row">
        ...
        <main class="col-md-10 col-lg-10 ms-sm-auto px-md-4">
            ...
            <form method='POST' action="{{ route('packages.update',['packageId' => $package->id])}}">
                @csrf
                @method('PUT')
                ...
                <div class="input-group mb-3">
                    ...
                    <input name="rental_time" value="{{$package->rental_time}}" type="number" class="form-control"
                ...
                <div class="input-group mb-3">
                    ...
                    <input name="price" value="{{$package->price}}" type="number" step="any" class="form-control"
                           aria-label="Sizing example input"
                           aria-describedby="inputGroup-sizing-default" required>
